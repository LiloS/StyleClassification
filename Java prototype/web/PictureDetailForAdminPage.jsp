...
<div align="center">
    ...
    <form id="PictureDetailServletID" method="post" action="PictureDetailForAdminServlet" name="result form"
          align="center">
        ...
        <p>User attitude: ${UserAttitude}</p>
        <p>In Training Set: ${InTrainingSet}</p>
        <p>User: ${User}</p>
        <p style="text-align: center;">
            <input name="AddToTrainingSet" type="submit" value="Add to Training Set"/>&nbsp;
            <input name="RemoveFromTrainingSet" type="submit" value="Remove from Training Set"/>
            <input name="Delete" type="submit" value="Delete"/></p>
        <p>Style:</p>
        <select name="style">
        ...
        <p><input name="ChangeStyle" type="submit" value="Set style"/></p>
        <p><input name="Reclassify" type="submit" value="Reclassify" onclick="ProcessingPainting()" class="myButton"/></p>
